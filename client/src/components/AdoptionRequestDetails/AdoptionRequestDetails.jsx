...
function AdoptionRequestDetails() {
  ...
  const fetchRequestDetails = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URI}/api/forms/${id}`, {
        headers: {
  ...
  const handleApprove = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URI}/api/forms/approve/${isNGOWorker ? 'ngo' : 'admin'}/${id}`, {
        method: 'PATCH',
        headers: {
  ...
  const handleReject = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URI}/api/forms/reject/${id}`, {
        method: 'PATCH',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
