...
function Signup() {
  ...
  const sendOTP = async () => {
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URI}/api/auth/send-otp`, {
        method: 'POST',
        headers: {
  ...
  const verifyOTP = async () => {
    try {
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URI}/api/auth/verify-otp`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleSubmit = async (e) => {
    ...
    const url = `${import.meta.env.VITE_BACKEND_URI}/api/auth/signup`;
