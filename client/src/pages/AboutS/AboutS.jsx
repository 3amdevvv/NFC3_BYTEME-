  ...
  return (
    <div className="about-page">
      ...
      <div className='about-content'>
        <h1 className='nuni abouts-page-title '>About PawPatrol</h1>
        
        <div className='text'>
          <div className='left animate-on-scroll slide-in-left'>
            <h2 className='nuni abouts-section-title '>Our Mission</h2>
            <p className='upper'>At PawPatrol, we rescue and rehabilitate pets from various backgrounds, including strays, abandoned pets, and those surrendered by their owners. Our dedicated team of volunteers provides medical care, socialization, and training to ensure each pet is ready for their new home.</p>
        ...
        <div style={{backgroundColor:'white',borderRadius:'15px'}}>
            <h2 className='nuni abouts-section-title' style={{color:'purple'}}>Meet Our Team</h2>
            <div className="team-members">
              {[
                { name: "Dr. ramchand Varghese", role: "Chief Veterinary Officer", description: "Dr. Thampi has over 15 years of experience in veterinary medicine and is passionate about animal welfare." ,image:profile1},
        ...
        <div className='ngo-info animate-on-scroll slide-in-left'>
          <p className='nuni'>PawPatrol is a registered non-profit organization dedicated to animal welfare and pet adoption. Founded in 2015, we have successfully rehomed over 5,000 pets and provided care for countless more.</p>
