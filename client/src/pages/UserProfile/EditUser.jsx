...
function EditUser() {
  ...
  const fetchUserDetails = async () => {
    try {
      ...
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URI}/api/auth/userprofile`, {
        headers: {
          'x-auth-token': token
        }
      });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const token = localStorage.getItem('token');
      const response = await fetch(`${import.meta.env.VITE_BACKEND_URI}/api/auth/edituser`, {
        method: 'PUT',
        headers: {
